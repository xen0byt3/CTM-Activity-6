...
1. Go to the repository: `CTM_Activity 6 VM`  
...
5. Enter your Name and Cyber Handle
6. Review the logs and threat descriptions
7. Select the correct port for each threat (1–4)
8. Each question has a time limit of 10 seconds
...
3. Submit both of the following to your instructor:
	...
	Upload the cyber_log_report.txt file to the GitHub repository via Pull Request
	Attach the screenshot on Google Classroom
...
2. Copy or move your cyber_log_report.txt file into the repo folder.
3. Stage and commit your changes:

	git add cyber_log_report.txt
	git commit -m "Add log report for CTM Activity 6"

4. Push the branch to GitHub:

	git push origin student_name_activity6

5. Go to the repository on GitHub and create a Pull Request for your branch.
